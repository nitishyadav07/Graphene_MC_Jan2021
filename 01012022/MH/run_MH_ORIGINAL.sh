...
python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.0 --J2 0.0 --N 20

#python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.2 --J2 -0.001 --N 80

#python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.2 --J2 -0.001 --N 20
...
#python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.0 --J2 0.0 --N 80
...
#python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.2 --J2 -0.001 --N 200

#python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.2 --J2 -0.001 --N 500
...
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 $i --J2 $j --N 1000
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 $i --J2 $j --N 400
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.2 --J2 0.001 --N 1000
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 0.2 --J2 0.001 --N 400
...
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 $i --J2 $j --N 200
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 $i --J2 $j --N 400
#		python3 Combined_My_ising_1D_GNP_GNR.py --J1 $i --J2 $j --N 500
#	done						
# done
